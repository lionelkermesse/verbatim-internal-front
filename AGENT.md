...
1. Familiarize yourself with the provided Java API code and the full specifications to understand the data models, endpoints, and business logic.(./docs/java-api)
